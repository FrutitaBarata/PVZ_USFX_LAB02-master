...
class AZombieComun;
class AEstados;
class AEstrategiaMovimientoSaltar;
UCLASS(MinimalAPI)
...
public:
	...
	AEstrategiaMovimientoSaltar* EstrategiaSaltar;
	float timerhandle;
...
protected:
	...
	AZombieComun* SpawnZombieComun(FVector _spawnPosition);
...
private:
	...
	AZombieComun* ZombieComunInstancia;
};
